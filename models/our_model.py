...
from utils.hyperbolic import mobius_add, expmap0, project, hyp_distance_multi_c, expmapP, expmapH, projectH, logmap0
...
class DVKGE(BaseH):
    ...
    def get_queries(self, queries):
        ...
        # head = logmap0(head, c_global)

        head = expmap0(head, c_local)
        rel_trans_g_1 = expmap0(rel_trans_g_1, c_local)
        head = project(mobius_add(head, rel_trans_g_1, c_local), c_local)
