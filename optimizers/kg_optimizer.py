...
class KGOptimizer(object):
    ...
    def __init__(
        ...
        self.local_kd_weight = args.local_kd_weight
        self.global_kd_weight = args.global_kd_weight
        ...
        with tqdm.tqdm(total=examples.shape[0], unit='ex', disable=not self.verbose) as bar:
            ...
            while b_begin < examples.shape[0]:
                ...
                if not noml:
                    ...
                    loss_local = (1. - self.local_kd_weight) * (kge_loss_local + reg_loss_local) + self.local_kd_weight * (kd_loss_local1 + self.args.feat_kd_weight * kd_loss_local2)
                    ...
                    loss_global = (1. - self.global_kd_weight) * (kge_loss_global + reg_loss_global) + self.global_kd_weight * (kd_loss_global1 + self.args.feat_kd_weight * kd_loss_global2)
