...
parser.add_argument(
    "--cuda_n", default=0, type=int, help="Cuda core number"
)

parser.add_argument(
    "--n_space", default=1, type=int, help="Number of manifold spaces"
)

parser.add_argument(
    "--valid_batchsize", default=500, type=int, help="Number of manifold spaces"
)
...
def train(args):
    ...
    # create dataset
    dataset_path = os.path.join("/dataset/data", args.dataset)
